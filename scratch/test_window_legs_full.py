...
class ElusiveWindowLegsOverlay:
    ...
    - Modèle 2D cartoon riche :
      * Plaque de fixation métallique rivetée sous le cadre de la fenêtre
      * Cuisses et mollets en jeans bleu athlétique avec coutures, reflets et genouillères
      * Chaussettes montantes de sport blanches à rayures rétro rouge et bleu
      * Grosses sneakers montantes de basket cartoon rouges, blanches et noires (Air Jordan / All-Star)
    ...
    - Animation de course cinématique avancée :
      ...
      * Poussière cartoon expansée à plusieurs lobes
      * Lignes de vitesse aérodynamiques cartoon derrière les talons
...
if __name__ == "__main__":
    root = tk.Tk()
    root.withdraw()
    overlay = ElusiveWindowLegsOverlay(root)
    overlay.phase = 1.0
    overlay._draw(is_moving=True, speed=18.0)
    print("ElusiveWindowLegsOverlay rendered successfully!")
    root.destroy()
